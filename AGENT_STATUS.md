...
| WD-028C | P0 | Worker 3 | DONE_FOCUSED_GREEN | Generate exactly 7 substantial regional landing pages with original summaries, rankings scoped to the region, provenance, schema, canonical URLs and bidirectional links; no thin country/region combinations. | WD-028A | `54a1eca` consumes only accepted `record.region` metadata and generates EAS 26, ECS 51, LCN 32, MEA 20, NAC 2, SAS 6 and SSF 45 pages. Each has data-derived median/mean/range/distribution summary, region-only ranking, full member table, canonical, WebPage/ItemList/Breadcrumb schema, official indicator/country-metadata provenance and Country↔Region links. Sitemap/build finalizer is idempotent at exactly 7 routes. Integrated focused related tests: 3/3 green. | Worker 4 integrates A2/B/C and verifies the seven regional routes plus mobile table containment once; no separate release by W3. Expected contribution: 7 high-intent organic/AI entry routes. |
| WD-028D | P0 | Worker 4 | READY_RELEASE | Integrate A2–C and execute one full release gate with CI, Pages, exact SHA, core/machine/regional routes and 360/390/430 px smoke. | WD-028A2 + WD-028B + WD-028C | A2, B and C are focused green on the integrated branch; Worker 3's final build commit is `54a1eca`. | Execute one release gate. LIVE VERIFIED or one owned incident chain. |
