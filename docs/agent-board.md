...
## Current evidence
- `main` at Worker 1 check: `ffe6d33a1206e6d3fdad489880211e550518c798`; no open PRs; main CI run 1350 completed successfully.
- Fresh Search Console check at 2026-09-10 19:15 Europe/Berlin still returns only finalized 2026-09-08 rows for Worker 1 pages; no Sep-9 or Sep-10 rows are finalized yet.
