...
function ensureShellCss(html) {
  const css = `<style id="wd-shared-shell-style">.wd-skip-link{position:absolute;left:1rem;top:.75rem;transform:translateY(-200%);padding:.65rem .85rem;border:2px solid #172033;border-radius:.5rem;background:#fff;color:#172033;font-weight:800;text-decoration:none}.wd-skip-link:focus{transform:none;z-index:1000}.wd-skip-target{display:block;position:relative;scroll-margin-top:.5rem}.wd-skip-target:focus{outline:none}.wd-global-header .nav{display:flex;gap:1rem;align-items:center;flex-wrap:wrap}.wd-global-header .nav a[aria-current=\"page\"]{font-weight:800;text-decoration:underline;text-underline-offset:.3rem}.wd-global-footer{margin-top:2rem}.wd-global-footer .wrap{line-height:1.8}@media(max-width:720px){.wd-global-header .wrap{display:block}.wd-global-header .brand{margin-bottom:.7rem}.wd-global-header .nav{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.45rem}.wd-global-header .nav a{min-height:42px;display:flex;align-items:center}.wd-global-footer .wrap{font-size:.95rem}}</style>`;
