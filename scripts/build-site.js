...
export async function buildSite() {
  ...
  const staticRoutes = await existingStaticRoutes(['/', '/data/', '/explore/', '/discoveries/', '/methodology/', '/sources/', '/archive/', '/status/', '/evidence/', '/indicators/', '/categories/economy/', '/indicators/gdp/', '/indicators/gdp-per-capita/', '/indicators/internet-use/', '/indicators/internet-use/region/', '/indicators/real-gdp/', '/leaderboard/']);
