...
function normalizeHref(value) {
  ...
  if (!path.endsWith('/index.html') && path !== 'index.html' && !path.endsWith('index.html')) return value;

  let normalized;
  if (path === 'index.html') normalized = './';
  else normalized = path.slice(0, -'index.html'.length);
