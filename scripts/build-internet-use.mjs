...
function makeHtml(data) {
  ...
  const description = `Compare ${data.observationYear} internet use as a percentage of population across a verified ${data.records.length}-country same-year comparison, with ITU/WDI provenance and JSON/CSV data.`;
  const dataset = {
    '@context': 'https://schema.org',
    '@type': 'Dataset',
    name: `Internet use by country — ${data.observationYear} verified comparison`,
    description: `A same-year verified comparison for ${data.indicator.code}, ${data.indicator.name}, sourced from ITU and surfaced through World Bank WDI.`,
    url: canonical,
