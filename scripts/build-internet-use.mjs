...
function makeHtml(data) {
  ...
  const dataset = {
    ...
    description: `A same-year verified subset for ${data.indicator.code}, ${data.indicator.name}, sourced from ITU and surfaced through World Bank WDI.`,
    url: canonical,
