...
function suffix(unit){if((unit||'').includes('%'))return '%';if(unit==='years')return ' years';if(unit==='metric tons per person')return ' t/person';if(unit==='t CO2e per capita')return ' t CO₂e/person';return '';}
