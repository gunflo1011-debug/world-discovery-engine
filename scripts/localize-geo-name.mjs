...
export function localizeCountryName(code, fallbackName, locale) {
  const explicit = NON_ISO_NAMES[code]?.[locale];
  ...
  try {
    ...
    return display.of(alpha2) || fallbackName;
  } catch {
    return fallbackName;
  }
}
