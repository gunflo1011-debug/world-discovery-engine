...
const ui = {
  en: {home:'Home',explore:'Explore',data:'Data',trends:'Trends',funFacts:'Fun Facts',countries:'Countries',compare:'Compare',about:'About',nav:'Main navigation',detailEyebrow:'Fun Fact',yes:'Yes, really.',why:'Why this is so weird',what:'What is actually happening?',deeper:'The detail that makes it even better',sources:'Sources',published:'Published',updated:'Updated',checked:'Claims checked against the sources above.',more:'← More Fun Facts',hubEyebrow:'One genuinely weird fact a day',hubTitle:'Fun Facts that make you say “wait… what?”',hubIntro:'Curious, absurd or surprising facts — selected by hand, explained with context and checked against serious sources. No rankings pretending to be trivia.',read:'Read the checked explanation →',pageTitle:'Fun Facts that are actually fun · World Discovery',pageDescription:'One surprising, source-checked fun fact a day — with the context behind each claim.',collectionName:'World Discovery Fun Facts',footer:'World Discovery · Curious facts, checked against serious sources.',socialAlt:'World Discovery — source-checked global data and discoveries'},
  ...
  'zh-Hans': {home:'首页',explore:'探索',data:'数据',trends:'趋势',funFacts:'趣味事实',countries:'国家',compare:'比较',about:'关于',nav:'主导航',detailEyebrow:'趣味事实',yes:'没错，是真的。',why:'为什么这件事如此惊人',what:'它到底是怎么发生的？',deeper:'让这个事实更精彩的细节',sources:'来源',published:'发布于',updated:'更新于',checked:'以上说法已根据上述来源核实。',more:'← 查看更多趣味事实',hubEyebrow:'每天一个真正令人惊讶的事实',hubTitle:'让你忍不住说“等等……什么？”的趣味事实',hubIntro:'人工挑选有趣、离奇或令人惊讶的事实，补充背景解释，并用可靠来源核实。这里不会把普通排名包装成冷知识。',read:'阅读已核实的解释 →',pageTitle:'真正有趣的趣味事实 · World Discovery',pageDescription:'每天一个令人惊讶并经过可靠来源核实的趣味事实，附带背景和解释。',collectionName:'World Discovery 趣味事实',footer:'World Discovery · 用可靠来源核实有趣事实。',socialAlt:'World Discovery — 经核实的全球数据与发现'}
};
