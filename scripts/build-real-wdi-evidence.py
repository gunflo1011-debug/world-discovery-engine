...
def main():
    ...
    for code in ENTITY_CODES:
        ...
        evidence={"schemaVersion":"1.4","status":"REAL","finding":{"type":finding,"isRevision":absolute!=0},"indicator":{"code":INDICATOR_CODE,"name":INDICATOR_NAME,"unit":UNIT,"methodologyVersion":METHODOLOGY_VERSION},"entity":{"code":code,"name":country,"entityType":"country","archivedNameVerifiedAcrossVintages":True},"referenceYear":REFERENCE_YEAR,
                  ...
                  "revision":{"absolute":absolute,"relative":relative},"generatedAt":generated,"methodologyNote":"Same WDI indicator code, archived indicator name, archived country identity, unit, sovereign country and reference year across two archived 2025 releases. Regional and income aggregates are excluded.","license":"CC BY 4.0 (World Bank WDI; preserve attribution)"}
