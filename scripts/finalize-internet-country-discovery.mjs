...
const [sitemap, rawBuild, rawIndex] = await Promise.all([
...
const additions = index.countries
...
console.log(`Added ${additions.length} internet-use country routes to discovery outputs.`);
